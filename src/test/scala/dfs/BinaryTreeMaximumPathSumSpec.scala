...
class BinaryTreeMaximumPathSumSpec extends AnyFlatSpec with Matchers {
    ...
    "BinaryTreeMaximumPathSum [5,4,8,11,null,13,4, 7,2,null,null,null,1]" should "48" in {
        val ti = new BinaryTreeMaximumPathSum()
    ...
    "BinaryTreeMaximumPathSumRec [5,4,8,11,null,13,4, 7,2,null,null,null,1]" should "48" in {
        val ti = new BinaryTreeMaximumPathSum()
